  ...
  h.prototype = {
    getBlob: function (a, e) {
      ...
      d.onload = function (d) {
        ...
        e({ img: b, src: this.result, blob: c.dataURItoBlob(this.result, a.name), name: a.name })
      };
      d.readAsDataURL(a)
    },
    getDragImage: function (a) {
      var e = this, c = f.getElementById(a.id);
    ...
    dataURItoBlob: function (a, e) {
      ...
      for (var b = new ArrayBuffer(c.length),
        d = new Uint8Array(b), f = 0;
        f < c.length;
        f++)d[f] = c.charCodeAt(f);
      return new Blob([b], { type: a, name: e ? e : "" })
    },
    getCropImage: function (a) {
      _this.getBlob(a[0], function (a) {
        var c = f.body || f.documentElement,
          b = g("div", "crop-box-bg", "crop-box-bg"),
          d = g("div", "crop-box", "crop-box"), e = g("div", "crop-box-cont", "crop-box-cont"),
